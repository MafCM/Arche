<div class="text-center font-120">
  <h1>Museo Arche</h1>
  <p>
...
<div id="carousel-sites" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="img/work-slide-6.png" class="d-block w-100" alt="Trabajo 6">
    </div>
  </div>
  <a class="carousel-control-prev" href="#carousel-sites" role="button" data-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="sr-only">Anterior</span>
  </a>
  <a class="carousel-control-next" href="#carousel-sites" role="button" data-slide="next">
